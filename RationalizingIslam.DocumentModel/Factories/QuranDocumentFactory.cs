...
namespace RationalizingIslam.DocumentModel.Factories
{
	public class QuranDocumentFactory
	{
		...
		void ReadArabic()
		{
			var structureQuranDoc = XDocument.Parse(RationalizingIslam.DocumentModel.Properties.Resources.QuranStructure);
			var structureQuranNode = structureQuranDoc.Document.Root;
			var tanzilQuranDoc = XDocument.Parse(RationalizingIslam.DocumentModel.Properties.Resources.quran_uthmani);
