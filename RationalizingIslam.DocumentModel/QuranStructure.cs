...
namespace RationalizingIslam.DocumentModel
{
	public static class QuranStructure
	{
		...
		static QuranStructure()
		{
			...
			var doc = XDocument.Parse(RationalizingIslam.DocumentModel.Properties.Resources.quran_uthmani);
			...
			doc = XDocument.Parse(RationalizingIslam.DocumentModel.Properties.Resources.QuranStructure);
